...
dedicated Python job checks deterministic behavior, environment, tracefile, and
diagnostics contract generation, mutation tests, retained corpus integrity, and
the current contract gate against the pinned LCOV source.
