...
SUITE_PATH=ROOT/"compat/cases/m0-residual-c-filters-contract.json"
SUITE_SCHEMA_PATH=ROOT/"compat/schema/suite.schema.json"
SUITE_ID="m0-residual-c-filters-contract"
FIXTURE="compat/fixtures/m0-residual-c-filters-contract"
CMP2=[{"dimension":d,"normalizer":"exact-v1"} for d in ("exit","filesystem")]
CANONICAL_CASES={"m0-residual-c-filters-contract-control": {"command": "lcov", "arguments": ["--config-file", "control.lcovrc", "--filter", "branch,blank", "--branch-coverage", "-a", "src/edges.info", "-o", "out.info", "--ignore-errors", "source,unsupported,empty,inconsistent,unused,mismatch,format,path"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}, "m0-residual-c-filters-contract-bitwise-conditional": {"command": "lcov", "arguments": ["--config-file", "bitwise-conditional.lcovrc", "--filter", "branch,blank", "--branch-coverage", "-a", "src/edges.info", "-o", "out.info", "--ignore-errors", "source,unsupported,empty,inconsistent,unused,mismatch,format,path"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}, "m0-residual-c-filters-contract-blank-aggressive": {"command": "lcov", "arguments": ["--config-file", "blank-aggressive.lcovrc", "--filter", "branch,blank", "--branch-coverage", "-a", "src/edges.info", "-o", "out.info", "--ignore-errors", "source,unsupported,empty,inconsistent,unused,mismatch,format,path"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}, "m0-residual-c-filters-contract-lookahead": {"command": "lcov", "arguments": ["--config-file", "lookahead.lcovrc", "--filter", "branch,blank", "--branch-coverage", "-a", "src/edges.info", "-o", "out.info", "--ignore-errors", "source,unsupported,empty,inconsistent,unused,mismatch,format,path"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}}
