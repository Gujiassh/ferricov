...
SUITE_PATH=ROOT/"compat/cases/m0-lcovrc-genhtml-residual4-contract.json"
SUITE_SCHEMA_PATH=ROOT/"compat/schema/suite.schema.json"
SUITE_ID="m0-lcovrc-genhtml-residual4-contract"
...
CANONICAL_CASES={"m0-lcovrc-genhtml-residual4-contract-control": {"command": "genhtml", "arguments": ["--config-file", "control.lcovrc", "--output-directory", "report", "input.info"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}, "m0-lcovrc-genhtml-residual4-contract-css": {"command": "genhtml", "arguments": ["--config-file", "css.lcovrc", "--output-directory", "report", "input.info"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}, "m0-lcovrc-genhtml-residual4-contract-date-bins": {"command": "genhtml", "arguments": ["--config-file", "date-bins.lcovrc", "--output-directory", "report", "input.info"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}, "m0-lcovrc-genhtml-residual4-contract-owner-table": {"command": "genhtml", "arguments": ["--config-file", "owner-table.lcovrc", "--output-directory", "report", "input.info"], "comparisons": [{"dimension": "exit", "normalizer": "exact-v1"}, {"dimension": "filesystem", "normalizer": "exact-v1"}]}}
