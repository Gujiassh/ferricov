...
def case_kind(case_id: str) -> str:
    ...
    if case_id.endswith((
        ...
        ".all-enabled",
        ".no-function-branch-mcdc",
        ".branch-only",
        ".mcdc-only",
        ".lines-only",
    )):
        # Feature-flag gated rewrites for wave-1 M1-TF-027 evidence.
        return "canonical_rewrite"
...
EXACT_CASE_REQUIREMENTS.update({
    "wave1-comments-core.summary": {"requirement_ids": ["M1-TF-002"]},
    "wave1-comments-core.canonical": {"requirement_ids": ["M1-TF-002"]},
    "wave1-comments-leading-space.summary": {"requirement_ids": ["M1-TF-002"]},
    "wave1-comments-leading-space.canonical": {"requirement_ids": ["M1-TF-002"]},
    "wave1-comments-leading-space.ignore-format": {"requirement_ids": ["M1-TF-002"]},
    "wave1-tn-names.summary": {"requirement_ids": ["M1-TF-003"]},
    "wave1-tn-names.canonical": {"requirement_ids": ["M1-TF-003"]},
    "wave1-tn-forget.canonical": {"requirement_ids": ["M1-TF-003"]},
    "wave1-sf-paths.summary": {"requirement_ids": ["M1-TF-005"]},
    "wave1-sf-paths.canonical": {"requirement_ids": ["M1-TF-005"]},
    "wave1-sf-empty.summary": {"requirement_ids": ["M1-TF-005"]},
    "wave1-sf-empty.canonical": {"requirement_ids": ["M1-TF-005"]},
    "wave1-sf-whitespace.summary": {"requirement_ids": ["M1-TF-005"]},
    "wave1-sf-whitespace.canonical": {"requirement_ids": ["M1-TF-005"]},
    "wave1-mcdc-core.canonical": {"requirement_ids": ["M1-TF-014"]},
    "wave1-mcdc-core.semantic-snapshot": {"requirement_ids": ["M1-TF-014"]},
    "wave1-mcdc-u-modes.canonical": {"requirement_ids": ["M1-TF-014"]},
    "wave1-mcdc-u-modes.clear-unreachable": {"requirement_ids": ["M1-TF-014"]},
    "wave1-order-canonical.canonical": {"requirement_ids": ["M1-TF-020"]},
    "wave1-order-canonical.semantic-snapshot": {"requirement_ids": ["M1-TF-020"]},
    "wave1-order-permuted.canonical": {"requirement_ids": ["M1-TF-020"]},
    "wave1-order-permuted.semantic-snapshot": {"requirement_ids": ["M1-TF-020"]},
    "wave1-repeat-same-tn.canonical": {"requirement_ids": ["M1-TF-023"]},
    "wave1-repeat-same-tn.semantic-snapshot": {"requirement_ids": ["M1-TF-023"]},
    "wave1-repeat-diff-tn-mcdc.canonical": {"requirement_ids": ["M1-TF-023"]},
    "wave1-repeat-diff-tn-mcdc.semantic-snapshot": {"requirement_ids": ["M1-TF-023"]},
    "wave1-features-all.default-function-only": {"requirement_ids": ["M1-TF-027"]},
    "wave1-features-all.all-enabled": {"requirement_ids": ["M1-TF-027"]},
    "wave1-features-all.no-function-branch-mcdc": {"requirement_ids": ["M1-TF-027"]},
    "wave1-features-all.branch-only": {"requirement_ids": ["M1-TF-027"]},
    "wave1-features-all.mcdc-only": {"requirement_ids": ["M1-TF-027"]},
    "wave1-features-all.lines-only": {"requirement_ids": ["M1-TF-027"]},
    "wave1-summary-payloads.canonical": {"requirement_ids": ["M1-TF-028"]},
})

EXACT_CASE_REQUIREMENTS.update({
    "wave2-framing-blank.summary": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-blank.canonical": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-crlf-blank.summary": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-crlf-blank.canonical": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-no-final-newline-blank.summary": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-no-final-newline-blank.canonical": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-trailing-ws.summary": {"requirement_ids": ['M1-TF-001']},
    "wave2-framing-trailing-ws.canonical": {"requirement_ids": ['M1-TF-001']},
    "wave2-tn-diff.summary": {"requirement_ids": ['M1-TF-004']},
    "wave2-tn-diff.canonical": {"requirement_ids": ['M1-TF-004']},
    "wave2-kf-parity.summary": {"requirement_ids": ['M1-TF-006']},
    "wave2-kf-parity.canonical": {"requirement_ids": ['M1-TF-006']},
    "wave2-kf-empty.summary": {"requirement_ids": ['M1-TF-006']},
    "wave2-kf-empty.canonical": {"requirement_ids": ['M1-TF-006']},
    "wave2-kf-empty.ignore-format": {"requirement_ids": ['M1-TF-006']},
    "wave2-da-accumulate.summary": {"requirement_ids": ['M1-TF-008']},
    "wave2-da-accumulate.canonical": {"requirement_ids": ['M1-TF-008']},
    "wave2-da-checksum-store.canonical": {"requirement_ids": ['M1-TF-008']},
    "wave2-da-checksum-store.no-verify.canonical": {"requirement_ids": ['M1-TF-008']},
    "wave2-summary-forms.summary": {"requirement_ids": ['M1-TF-012']},
    "wave2-summary-forms.canonical": {"requirement_ids": ['M1-TF-012']},
    "wave2-terminator-suffix.summary": {"requirement_ids": ['M1-TF-015']},
    "wave2-terminator-suffix.canonical": {"requirement_ids": ['M1-TF-015']},
    "wave2-terminator-dup.summary": {"requirement_ids": ['M1-TF-015']},
    "wave2-terminator-dup.canonical": {"requirement_ids": ['M1-TF-015']},
    "wave2-terminator-missing.summary": {"requirement_ids": ['M1-TF-015']},
    "wave2-terminator-missing.canonical": {"requirement_ids": ['M1-TF-015']},
    "wave2-terminator-missing.ignore-empty": {"requirement_ids": ['M1-TF-015']},
    "wave2-unknown-tags.summary": {"requirement_ids": ['M1-TF-016']},
    "wave2-unknown-tags.canonical": {"requirement_ids": ['M1-TF-016']},
    "wave2-unknown-tags.ignore-format": {"requirement_ids": ['M1-TF-016']},
    "wave2-leading-ws-tag.summary": {"requirement_ids": ['M1-TF-016']},
    "wave2-leading-ws-tag.canonical": {"requirement_ids": ['M1-TF-016']},
    "wave2-leading-ws-tag.ignore-format": {"requirement_ids": ['M1-TF-016']},
    "wave2-case-change.summary": {"requirement_ids": ['M1-TF-016']},
    "wave2-case-change.canonical": {"requirement_ids": ['M1-TF-016']},
