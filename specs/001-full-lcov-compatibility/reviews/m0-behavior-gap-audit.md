...
and eight fixed-epoch `genhtml` config cases, 397 primary plans are substantive
and reviewed; 134 remain explicit M0 planning gaps. Product
...
| --- | ---: | --- |
| `lcovrc` consumer semantics | 90 | responsibility-split `m0-lcovrc-*.json` fragments |
...
`lcov` residuals are closed. The totals reconcile to `90 + 44 = 134`.
