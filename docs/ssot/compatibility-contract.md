...
| behavior planning | primary plans cover all 531 public entries | not started | 377 substantive reviewed primary plans with 379 fixed source/interaction projections; 154 explicit M0 gaps remain; 3 support-script and 13 command plans have executable suite bindings; all product evidence remains empty |
