...
| behavior planning | primary plans cover all 531 public entries | not started | 382 substantive reviewed primary plans with 384 fixed source/interaction projections; 149 explicit M0 gaps remain; 3 support-script and 18 command plans have executable suite bindings; `perl2lcov --preserve` remains unbound; all product evidence remains empty |
