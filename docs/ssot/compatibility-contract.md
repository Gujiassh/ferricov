...
| behavior planning | primary plans cover all 531 public entries | not started | 364 substantive reviewed primary plans with 366 fixed source/interaction projections; 167 explicit M0 gaps remain; the first 3 support-script plans have executable suite bindings; all product evidence remains empty |
