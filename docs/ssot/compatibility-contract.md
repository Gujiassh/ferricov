...
| behavior planning | primary plans cover all 531 public entries | not started | 370 substantive reviewed primary plans with 372 fixed source/interaction projections; 161 explicit M0 gaps remain; 3 support-script and 6 small-command plans have executable suite bindings; all product evidence remains empty |
