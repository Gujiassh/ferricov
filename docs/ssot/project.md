...
- `compat/behavior/contract.json` creates a primary plan for every one of the
  ...
  independently seal 384 projections; 382 substantive primary plans are
  reviewed and 149 explicit M0 gaps remain. The support-script planning suite
  ...
  `perl2lcov` residuals. Their argv is executable on the pinned Oracle. Product
